# Bernstein-Vazirani Algorithm — IBM Quantum Runtime version
...
def run_dj_experiment(file_path, shots):
    ...
    print("\n" + "=" * 40)
    print(" 2. FULL BV CIRCUIT (Initialization + Oracle + Interference) ")
    print("=" * 40)
    print(dj_circuit.draw(output="text", fold=-1))

    # Extract the most probable measured string
    measured_string = max(counts, key=counts.get)
    print(f"The secret string is- {measured_string}")
